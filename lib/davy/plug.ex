defmodule Davy.Plug do
  ...
  - `:lock_store` — module implementing `Davy.LockStore`
    (default: `Davy.LockStore.ETS`)
  ...
  def init(opts) do
    %{
      ...
      lock_store: Keyword.get(opts, :lock_store, Davy.LockStore.ETS),
